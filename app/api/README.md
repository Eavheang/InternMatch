...
**GET** `/api/job/{jobId}/apply?userId={userId}`

Check if a student has applied for a specific job.
...
Update the status of an application (shortlist, reject, interview, hire).
...
- Students can only apply for open jobs
