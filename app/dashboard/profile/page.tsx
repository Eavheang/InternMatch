...
function SearchableMultiSelect({ 
  ...
  useEffect(() => {
    if (query.trim() === "") {
      ...
      setFilteredItems(
        items
          .filter(item => item.toLowerCase().includes(lowerQuery) && !selectedItems.includes(item))
    ...
    <div className="space-y-4" ref={wrapperRef}>
      <div className="flex flex-wrap gap-2 min-h-[40px]">
        {selectedItems.length === 0 && (
            <p className="text-sm text-zinc-400 italic py-2">No items added yet.</p>
        )}
        {selectedItems.map((item) => (
          <div key={item} className="bg-indigo-50 text-indigo-700 border border-indigo-100 px-3 py-1.5 rounded-full text-sm font-medium flex items-center gap-2 transition-all hover:bg-indigo-100">
            {item}
            <button onClick={() => onRemoveItem(item)} className="text-indigo-400 hover:text-indigo-700">
...
export default function StudentProfilePage() {
  ...
  useEffect(() => {
    if (profileData) {
      ...
      setGpa((profileData.gpa as any)?.toString() || "");
      ...
      if (profileData.socialLinks) {
          const social = profileData.socialLinks as any;
  ...
  return (
    <div className="max-w-5xl mx-auto p-8 space-y-8 pb-24">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button onClick={handleSave} disabled={isLoading} className="bg-indigo-600 hover:bg-indigo-700 transition-all shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-8">
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
              <div className="space-y-2.5">
                <Label htmlFor="firstName" className="text-zinc-600 font-medium">First Name</Label>
                <Input 
                  id="firstName" 
                  value={firstName} 
              ...
              <div className="space-y-2.5">
                <Label htmlFor="lastName" className="text-zinc-600 font-medium">Last Name</Label>
                <Input 
                  id="lastName" 
                  value={lastName} 
      ...
      <Card className="border-zinc-200 shadow-sm">
        <CardHeader className="px-8 pt-8 pb-4">
          <CardTitle className="text-lg font-semibold text-zinc-900">Contact Information</CardTitle>
        ...
        <CardContent className="px-8 pb-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="sm:col-span-2 space-y-2.5">
            <Label htmlFor="location" className="text-zinc-600">Location</Label>
            <div className="relative">
      ...
      <Card className="border-zinc-200 shadow-sm">
        <CardHeader className="px-8 pt-8 pb-4">
          <CardTitle className="text-lg font-semibold text-zinc-900">Education</CardTitle>
          <p className="text-sm text-zinc-500">Your academic background</p>
        </CardHeader>
        <CardContent className="px-8 pb-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-2.5 sm:col-span-2">
            <Label htmlFor="university" className="text-zinc-600">University</Label>
            <Input 
              id="university" 
              value={university} 
          ...
          <div className="space-y-2.5">
            <Label htmlFor="degree" className="text-zinc-600">Degree</Label>
            <Input 
              id="degree" 
              value={degree} 
          ...
          <div className="space-y-2.5">
            <Label htmlFor="major" className="text-zinc-600">Major</Label>
            <Input 
              id="major" 
              value={major} 
          ...
          <div className="space-y-2.5">
            <Label htmlFor="gpa" className="text-zinc-600">GPA</Label>
            <Input 
              id="gpa" 
              value={gpa} 
          ...
          <div className="space-y-2.5">
            <Label htmlFor="gradYear" className="text-zinc-600">Graduation Year</Label>
            <Input 
              id="gradYear" 
              value={gradYear} 
      ...
      <Card className="border-zinc-200 shadow-sm">
        <CardHeader className="px-8 pt-8 pb-4">
          <CardTitle className="text-lg font-semibold text-zinc-900">Skills</CardTitle>
          <p className="text-sm text-zinc-500">Add your technical and soft skills</p>
        </CardHeader>
      ...
      <Card className="border-zinc-200 shadow-sm">
        <CardHeader className="px-8 pt-8 pb-4">
          <CardTitle className="text-lg font-semibold text-zinc-900">Career Interests</CardTitle>
          <p className="text-sm text-zinc-500">What areas are you interested in?</p>
        </CardHeader>
        <CardContent className="px-8 pb-8">
          <SearchableMultiSelect 
            items={careerList} 
      ...
      <Card className="border-zinc-200 shadow-sm">
        <CardHeader className="px-8 pt-8 pb-4">
          <CardTitle className="text-lg font-semibold text-zinc-900">Social Links</CardTitle>
          <p className="text-sm text-zinc-500">Connect your professional profiles</p>
        </CardHeader>
        <CardContent className="px-8 pb-8 space-y-4">
          <div className="space-y-2.5">
            <Label htmlFor="linkedin" className="text-zinc-600">LinkedIn</Label>
            <div className="relative">
          ...
          <div className="space-y-2.5">
            <Label htmlFor="github" className="text-zinc-600">GitHub</Label>
            <div className="relative">
          ...
          <div className="space-y-2.5">
            <Label htmlFor="portfolio" className="text-zinc-600">Portfolio Website</Label>
            <div className="relative">
              <GlobeIcon className="absolute left-3 top-3.5 h-4 w-4 text-zinc-400" />
              <Input 
                id="portfolio" 
      ...
      <Card className="border-zinc-200 shadow-sm">
        <CardHeader className="px-8 pt-8 pb-4">
          <CardTitle className="text-lg font-semibold text-zinc-900">About Me</CardTitle>
          <p className="text-sm text-zinc-500">Write a brief introduction about yourself</p>
        </CardHeader>
        <CardContent className="px-8 pb-8">
          <textarea 
