...
import { Loader2, MessageSquare, Brain, FileText } from "lucide-react";
        ...
        {!questions ? (
          ...
          <div className="divide-y divide-zinc-100">
            {questions.questions.map((q, idx) => (
              <div
                key={idx}
                className="p-6 bg-white hover:bg-zinc-50/50 transition-colors"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <Badge
                        variant="outline"
                        className={`capitalize shrink-0 font-normal ${
                          q.difficulty === "easy"
