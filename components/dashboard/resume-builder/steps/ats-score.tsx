      ...
      setResult({
        ...
        suggestions: analysis.suggestions
          ? analysis.suggestions.map(
              (s: { field: string; advice: string }) => s.advice
            )
          : [],
      });
  ...
  const improveWithAI = async () => {
    ...
    try {
      ...
      if (data.data) {
        ...
        toast.success(
          "Resume improved! Changes have been applied. You can re-analyze to see the updated score."
        );
        ...
        try {
          ...
          if (
            ...
            htmlEl.style.backgroundColor =
              htmlEl === clone ? "#ffffff" : "transparent";
          }
        } catch {
          // Ignore errors
        }
    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t">
        <Button
          ...
          title={
            !canAnalyze
              ? "Please add some content to your resume before analyzing"
              : undefined
          }
        >
          {isAnalyzing ? (
