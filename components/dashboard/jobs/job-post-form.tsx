      ...
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-500">
            Craft a compelling job post to attract top student talent. Fill in
              ...
              <Field label="Skills" required>
                <div className="relative">
                  ...
                  <p className="text-xs text-slate-500 mt-2">
                    Select skills from the dropdown or type to search. Press
                    Enter to add the first suggestion.
                  </p>
                </div>
              </Field>
          ...
          <Card className="border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50/50 shadow-lg overflow-hidden">
            ...
            <CardContent className="p-5">
              <p className="text-sm text-blue-900/80 mb-4 leading-relaxed">
                Our intelligent matching system analyzes your job description to
                connect you with the most qualified candidates.
              </p>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Detailed job descriptions with clear responsibilities and
                    qualifications receive 3x more qualified applicants.
                  </p>
                </div>
              </div>
            </CardContent>
